    ...
    <div className="flex lg:flex-row flex-col  w-full  bg-gray-200 overflow-x-hidden">
      ...
      <div className=" w-full lg:w-[18%] bg-[#f5f0ebec] flex flex-col  pb-9 items-center px-2 py-10 lg:rounded-r-4xl">
        ...
        <div className="   w-[75%] px-2  py-5 flex flex-col  gap-4 items-center justify-center">
...

          {
            Ai && (
              <div className="   p-1 w-[65%] sm:w-[30%] lg:w-full flex flex-col gap-2 ">
                <button className=" py-2  px-2  w-full rounded-xl bg-gray-400 ">Enhnace Summary</button>
                <button className=" py-2  px-2  w-full rounded-xl bg-gray-400 ">Enhance Achievements</button>
                <button className=" py-2  w-full rounded-xl bg-gray-400 ">Enhnace Experience</button>
                <button className=" py-2  w-full rounded-xl bg-gray-400 ">Enhnace Project </button>
              </div>
            )
          }  
          ...
          <button className=" w-[65%] sm:w-[30%] lg:w-full bg-[#63265d] text-white  py-2  rounded-full" onClick={alertmsg}>Save Changes</button>
        ...
        <div className=" w-full sm:w-[calc(100%-30%)] flex flex-col gap-2">
          ...
          {/* Summary */}
           <div className=" w-full mt-6 ">
               ...
               <div className=" w-full ">
                    <p contentEditable className="p-2 text-justify" onChange={(e)=>handleChange('summary',e.target.value)}>{formData.summary}</p>
               </div>
          </div>
