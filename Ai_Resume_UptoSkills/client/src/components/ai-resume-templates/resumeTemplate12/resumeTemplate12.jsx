...
const Sidebar = React.memo(
  ({
    ...
    return (
      <div className="w-full lg:w-16 xl:w-72 bg-white text-gray-800 p-3 sm:p-4 lg:p-6 rounded-none lg:rounded-r-3xl shadow-lg lg:shadow-2xl border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-row lg:flex-col items-center justify-between lg:justify-start overflow-x-auto lg:overflow-x-visible">
        <div className="w-full flex flex-row lg:flex-col items-center lg:items-start space-x-2 lg:space-x-0 space-y-0 lg:space-y-4 xl:space-y-6 z-10">
          <h3 className="text-lg xl:text-xl font-bold mb-0 lg:mb-4 xl:mb-6 text-gray-800 hidden xl:block">
            Resume Tools
          </h3>
          <button
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-12 lg:h-12 xl:w-full xl:h-auto bg-blue-500 text-white rounded-full p-2 xl:p-3 shadow-lg flex items-center justify-center xl:flex-row xl:justify-start xl:space-x-2 flex-shrink-0"
            onClick={() => setActiveSection("rearrange")}
          >
            <span className="text-lg sm:text-xl xl:text-lg">↕️</span>
            <span className="hidden xl:inline">Rearrange</span>
          </button>
          <button
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-12 lg:h-12 xl:w-full xl:h-auto bg-red-500 text-white rounded-full p-2 xl:p-3 shadow-lg flex items-center justify-center xl:flex-row xl:justify-start xl:space-x-2 flex-shrink-0"
            onClick={() => setShowAIMenu(!showAIMenu)}
          >
            <span className="text-lg sm:text-xl xl:text-lg">🤖</span>
            <span className="hidden xl:inline">AI Assistant</span>
          </button>

          {showAIMenu && (
            <div className="fixed lg:relative top-0 left-0 w-full lg:w-auto bg-white lg:bg-transparent p-4 lg:p-0 shadow-lg lg:shadow-none z-50 lg:z-auto lg:ml-4 xl:ml-6">
              ...
              <p className="text-xs lg:text-sm text-gray-600 font-medium mb-2 hidden lg:block">
                Enhance Specific Field
              </p>
              <div className="flex flex-col space-y-2">
                <button
                  className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-2 lg:px-4 lg:py-3 rounded-md text-center text-xs lg:text-sm font-medium"
                  onClick={() => {
                    setIsLoading(true);
          ...
          <button
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-12 lg:h-12 xl:w-full xl:h-auto bg-purple-500 text-white rounded-full p-2 xl:p-3 shadow-lg flex items-center justify-center xl:flex-row xl:justify-start xl:space-x-2 flex-shrink-0"
          ...
          <button
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-12 lg:h-12 xl:w-full xl:h-auto bg-indigo-500 text-white rounded-full p-2 xl:p-3 shadow-lg flex items-center justify-center xl:flex-row xl:justify-start xl:space-x-2 flex-shrink-0"
            onClick={() => alert("Resume saved successfully!")}
          >
            <span className="text-lg sm:text-xl xl:text-lg">💾</span>
            <span className="hidden xl:inline">Save Resume</span>
          </button>
          <hr className="border-gray-300 my-2 w-full hidden xl:block" />
          <button
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-12 lg:h-12 xl:w-full xl:h-auto bg-yellow-500 text-white rounded-full p-2 xl:p-3 shadow-lg flex items-center justify-center xl:flex-row xl:justify-start xl:space-x-2 flex-shrink-0"
          ...
          <button
            className="w-10 h-10 sm:w-12 sm:h-12 lg:w-12 lg:h-12 xl:w-full xl:h-auto bg-green-500 text-white rounded-full p-2 xl:p-3 shadow-lg flex items-center justify-center xl:flex-row xl:justify-start xl:space-x-2 flex-shrink-0"
            onClick={handleShare}
          >
            <span className="text-lg sm:text-xl xl:text-lg">🔗</span>
            <span className="hidden xl:inline">Share</span>
          </button>
          <div className="flex items-center justify-center xl:justify-between mt-2 w-auto xl:w-full">
...
const ResumeEditor = () => {
  ...
  const AIErrorPopup = () => <AIEnhancementPanel />;
    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-2 sm:p-4 lg:p-6 overflow-auto flex justify-center">
        ...
        >
          <div
            ref={resumeRef}
            className="p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col"
            style={{
              width: "100%",
              minHeight: "297mm",
              boxSizing: "border-box",
            ...
            <div className="flex flex-col sm:flex-row items-start justify-between mb-4 gap-4">
              <div className="flex-1 w-full sm:w-auto">
                <h1
                  ...
                  className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 uppercase tracking-wide"
                >
                  {resumeData.name}
                </h1>
              ...
              {sectionSettings.header.showPhoto && (
                <div className="flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full bg-blue-500 flex items-center justify-center text-white text-lg sm:text-xl lg:text-3xl font-bold">
                  AT
                </div>
              )}
            </div>
